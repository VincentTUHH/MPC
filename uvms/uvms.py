...
def init_uvms_model(
    ...
    global USE_QUATERNION, USE_PWM, USE_FIXED_POINT, FIXED_POINT_ITER, N_HORIZON, V_BAT, L, MIXER, M_INV, MIXER_NULLSPACE, JOINT_LIMITS, JOINT_EFFORTS, JOINT_VELOCITIES, INTEGRATOR, N_DOF, N_JOINTS, STATE_DIM, CTRL_DIM, C_FUN, D_FUN, G_FUN, J_FUN
    ...
    with _LOCK:
        ...
        MIXER_NULLSPACE = BLUEROV_DYN.mixer_nullspace
